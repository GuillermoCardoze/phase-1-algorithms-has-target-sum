...
```
make a function 'hasTargetSum' that checks if two numbers from the array add up to tsome target.For example, if I have an array [1,2,3,4] and the target is '6' I should return true because 2 and 4 add to 6.
